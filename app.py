...
'''
        ...
        generated_code = f"Modelo: {model_type}, Tipo de Dados: {data_type}, Framework: {framework} não tem código base definido."
...
def generate_code_route():
    ...
    generated_code = generate_code(model_type, data_type, framework)
    return render_template('index.html', generated_code=generated_code, 
                           model_type=model_type, data_type=data_type, framework=framework)
...
def download_code():
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix='.py') as temp_file:
        ...
        return send_file(temp_file.name, as_attachment=True, download_name=f"{model_type}_{data_type}_{framework}_generated_code.py")
